...
export type CreateRootTestData = RealmTestData;

export const successfulCreateRootTestData: CreateRootTestData[] = [
  // Community side, no plugins
  new RealmTestData({
    splGovernanceId: new PublicKey(
      'GovErnqK4XvMPN1Njxh1zTQpzzzPZUaJQGjHM9qHjMHr'
    ),
    id: new PublicKey('BvQys4bSSzv8HnTUse17x6sm67qbQ5u7xj2BiCkQZc4d'),
    ...
    authority: buildKeypair(
      ...
      [
        ...
        254, 208, 250, 42, 212, 240, 136, 55, 111, 57, 238, 82, 10, 86, 103, 14,
        138, 200, 68, 16, 85, 148, 62, 51, 52, 232, 207, 157, 125, 113, 181, 14,
        181, 26, 174, 197, 83, 27, 235, 159, 130, 54, 243, 41, 208, 237, 167,
        107,
      ]
    ),
  ...
  new RealmTestData({
    ...
    id: new PublicKey('HaP8jMNA5tyyZo4WUybWzw2JDm26ks1tM8hzdtFgQ9j4'),
    communityMint: new PublicKey(
    ...
    authority: buildKeypair(
      ...
      [
        52, 150, 62, 72, 210, 82, 150, 77, 67, 123, 83, 220, 233, 40, 252, 240,
        63, 179, 19, 22, 172, 92, 171, 167, 138, 115, 247, 222, 39, 201, 75, 25,
        214, 53, 101, 170, 191, 239, 19, 250, 246, 196, 209, 225, 104, 136, 77,
        20, 223, 240, 54, 16, 20, 73, 216, 168, 142, 114, 4, 123, 95, 113, 146,
        116,
      ]
    ),
  ...
  new RealmTestData({
    ...
    id: new PublicKey('BgdaaVW8xi3stnmSQxDgbUSrKETHehgKdZnDLf25nqoc'),
    communityMint: new PublicKey(
      '2XjVUAVYD6fUnUBoJqLNbQjufdQft4PtxcQwLMkuQrpM'
    ),
    councilMint: new PublicKey('25fzgPBoXMgds3XmZLq1ECVF4HNoBd7RAh9nBoScEdpp'),
    communityMintMaxVoterWeightSource: {
      supplyFraction: new BN(50),
    },
    ...
    authority: buildKeypair(
      ...
      [
        ...
        22, 174, 226, 14, 206, 147, 6, 81, 62, 124, 135, 247, 93, 74, 151, 240,
        22, 157, 82, 251, 177, 66, 119, 0, 192, 196, 242, 102, 139, 72, 245,
        219, 184, 223,
      ]
    ),
  ...
  new RealmTestData({
    ...
    id: new PublicKey('9a5LFeRuT5mSvFw5pNQFCaXLJb4HE83JBxY9s2BnAiiZ'),
    communityMint: new PublicKey(
      'B4wVHPFEBvhsMxsrEYX2cVbTfcfQiLZMh7XbofeDofhd'
    ),
    councilMint: new PublicKey('EpdNSa67fpomhxXSKaL5fwaCPQGYbWVPf7k6NvpJZnCd'),
    communityMintMaxVoterWeightSource: {
    ...
    authority: buildKeypair(
      ...
      [
        184, 242, 81, 232, 89, 137, 27, 71, 105, 48, 158, 18, 156, 30, 252, 44,
        147, 67, 82, 156, 62, 140, 240, 147, 144, 17, 250, 174, 242, 209, 255,
        80, 255, 227, 88, 130, 138, 9, 7, 245, 142, 25, 6, 32, 226, 243, 47, 86,
        184, 50, 114, 218, 177, 180, 172, 183, 46, 116, 43, 108, 47, 12, 192,
        161,
      ]
    ),
