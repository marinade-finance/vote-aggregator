...
export const successfulCreateRootTestData0: CreateRootTestData[] = [
...
export const successfulCreateRootTestData = /*[
  // successfulCreateRootTestData0[0],
  successfulCreateRootTestData0[3],
];*/ successfulCreateRootTestData0;
